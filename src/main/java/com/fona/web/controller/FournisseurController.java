...
public class FournisseurController {
    ...
    private static Logger logger = Logger.getLogger(FournisseurController.class.
            getName());

    @RequestMapping(value = "/{id}/show", method = RequestMethod.GET)
    public String showAction(@PathVariable("id") final Long id,
                             final ModelMap model, WebRequest webRequest) {
        ...
        final Integer size = webRequest.getParameter("size") != null ? Integer.
                valueOf(webRequest.getParameter("size")) : 55;
        final Fournisseur fournisseur = fournisseurService.findOne(id);

        Page<Entree> resultPage = entreeService.
                findByFournisseur(id, page, size);
    ...
    public String indexAction(final ModelMap model, final WebRequest webRequest) {
        ...
        final String code = webRequest.getParameter("querycode") != null ? webRequest.
                getParameter("querycode") : "";
        final String nom = webRequest.getParameter("querynom") != null ? webRequest.
                getParameter("querynom") : "";
        final String cni = webRequest.getParameter("querycni") != null ? webRequest.
                getParameter("querycni") : "";
        final String prenom = webRequest.getParameter("queryprenom") != null ? webRequest.
                getParameter("queryprenom") : "";
        final String numeroContribuable = webRequest.getParameter(
                "querynumeroContribuable") != null ? webRequest.getParameter(
                                "querynumeroContribuable") : "";

        System.out.println("Liste des fournisseurs dans le controlleur...");
        final Page<Fournisseur> resultpPage = fournisseurService.findPaginated(
                page, size);
    ...
    public String createAction(@Valid final Fournisseur fournisseur,
        ...
        if (result.hasErrors()) {
            ...
            final Fournisseur fournisseurCreated = fournisseurService.create(
                    fournisseur);
    ...
    public String updateAction(@Valid final Fournisseur fournisseur,
